...
@section('content')
<div class="container makecliable">
    <div class="row justify-content-center " style="margin-top: 16%;/* margin-bottom: 50%; */">
        <div class="col-md-8">
                <h3 class="mb-5 text-center text-white pt-5" style="font-weight: bold;"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; {{ __('Register') }}</h3>
